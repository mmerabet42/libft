...
/*   Updated: 2018/01/19 22:34:20 by mmerabet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_btree.h"

static void	inner_btree_lov(t_btree *bt, t_btiter f, int nm[2], void *data)
{
	if (!bt)
		return ;
	if (nm[0] == nm[1])
...
static void	ft_btree_levelorderv(t_btree *bt, t_btiter f, void *data)
{
	int	n;
	int	i;
	int	nm[2];
...
void		ft_btree_itermv_d(t_btree *bt, t_btiter f, t_btmode mode,
						void *data)
{
	if (!bt || !f)
		return ;
...
void		ft_btree_iterv_d(t_btree *bt, t_btiter f, void *data)
{
